    ...
    <div>
      ...
      {error && !stats ? (
        ...
        <div className="mt-2 grid gap-3 sm:grid-cols-3">
          {/* Total */}
          <div className="rounded-xl border border-shore-200 bg-surface p-4">
            <p className="text-2xl font-semibold text-navy">
              {stats ? stats.total.toLocaleString('id-ID') : '—'}
            </p>
            <p className="mt-0.5 text-[11px] text-navy-soft">Total karang terdeteksi</p>
          </div>

          {/* Status kesehatan */}
          <div className="rounded-xl border border-shore-200 bg-surface p-4">
            <p className="mb-2.5 text-[12px] font-medium text-navy">Status Kesehatan</p>
            {stats && stats.total > 0 ? (
              ...
              <p className="text-[11px] text-navy-soft">Belum ada data</p>
            )}
          </div>

          {/* Jenis karang */}
          <div className="rounded-xl border border-shore-200 bg-surface p-4">
            <p className="mb-2.5 text-[12px] font-medium text-navy">Jenis Karang</p>
            {topJenis.length > 0 ? (
              <div className="space-y-2">
